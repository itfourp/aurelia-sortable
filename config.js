System.config({
  ...
  bundles: {
    "app-build": [
      ...
      "list-sortable.html!github:systemjs/plugin-text@0.0.2",
      "flickr-sortable.html!github:systemjs/plugin-text@0.0.2",
  ...
  map: {
    ...
    "oribella/aurelia-sortable": "github:oribella/aurelia-sortable@0.3.1",
